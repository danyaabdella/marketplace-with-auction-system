      ...
      <div className="mb-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          ...
          <Button
            className={cn(
              "mt-4 sm:mt-0",
              canEdit ? "gradient-bg border-0" : "bg-muted text-muted-foreground cursor-not-allowed",
            )}
            onClick={() => canEdit && setIsEditAuctionOpen(true)}
            disabled={!canEdit}
          >
            ...
            <Card className="border-destructive">
              ...
              <CardContent className="pt-4">
                ...
                <Button
                  ...
                  onClick={() => router.push(`/dashboard/auctions/${auctionData.id}/edit`)}
                >
                  <Edit className="mr-2 h-4 w-4" />
                  Edit Auction
                </Button>
