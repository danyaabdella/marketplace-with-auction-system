...
export async function POST(req) {
    try {
        ...
        const previousHighestBidder = bid.highestBidder ? bid.highestBidder.toString() : null;
        ...
        const participants = [...new Set(bid.bids.map(b => b.bidderId.toString()))];
        ...
        for (const participant of participants) {
            ...
            if (participant === previousHighestBidder && previousHighestBidder !== bidderId.toString()) {
        ...
        const emailRecipients = participants.filter(p => p !== bidderId.toString());
